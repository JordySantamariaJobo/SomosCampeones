...
$("#regisuser").click(function(){
    var nom = $("#user").val();
    var app = $("#app").val();
    var nomusu = $(".nombreusuario").val();
    var mail = $("#mail").val();
    var pwd = $("#pwd").val();
    var fec = $("#fec").val();
    var team = $("#dropteam").val();
    var cod_inv = $("#cod_inv").val();
    var ajax_data = {
        "nombre": nom,
        "app": app,
        "nombreusu": nomusu,
    ...
    $.ajax({
        ...
        success: function(result){
            if (result == "CodigoNoExiste"){ $("#CodigoNoExiste").modal("show"); }
            else if(result == "CorreoExiste"){ $("#CorreoExiste").modal("show"); }
            else if(result == "Perfecto"){ location.href="editarperfil.php"; }
        },
        error: function(){
