        		...
        		<ul class="nav navbar-nav navbar-right" style="padding-right:15px;">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-large row">
							...
							<li class="col-sm-12">
								<ul>
									<li class="dropdown-header M8"><?php echo NavBarC::MensajeSesion(); ?></li>
									<li class="divider"></li>
									...
									<li class="dropdown-header"><center><a href="Recovery.php" style="color: #002242;">¿Olvidaste tu contraseña?</a></center></li>
								</ul>
							</li>
							<?php	}	?>				
						</ul>
